            ...
            <div class="grid gap-y-4">
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <button type="button" id="toggle-password" class="absolute inset-y-0 right-0 flex items-center px-3">
                    <svg id="eye-icon" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500 dark:text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.998 7.668 4.5 12 4.5s8.268 3.498 9.542 7.5C20.268 16.002 16.332 19.5 12 19.5S3.732 16.002 2.458 12z" />
                    </svg>
                </button>
                  @error('password')
                 <div class=" absolute inset-y-0 end-0 flex items-center pointer-events-none pe-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    togglePassword.addEventListener('click', function() {
        ...
        if (passwordInput.type === 'password') {
            ...
            // Change the icon to 'eye-slash' or similar
            eyeIcon.setAttribute('d', 'M1 12s3.732 7.5 11 7.5 11-7.5 11-7.5S14.268 4.5 6 4.5 1 12 1 12z'); // Adjust SVG path for "eye-slash" icon
        } else {
            passwordInput.type = 'password';
            // Change the icon back to 'eye'
            eyeIcon.setAttribute('d', 'M15 12c0 1.657-1.343 3-3 3s-3-1.343-3-3 1.343-3 3-3 3 1.343 3 3z M2.458 12C3.732 7.998 7.668 4.5 12 4.5s8.268 3.498 9.542 7.5C20.268 16.002 16.332 19.5 12 19.5S3.732 16.002 2.458 12z'); // Adjust SVG path for "eye" icon
        }
    });
});
