          ...
          <table class="w-full">
            ...
            <tbody>
              ...
              <tr wire:key="{{$item['product_id']}}">
                ...
                <td><button wire:click="removeItem({{ $item['product_id'] }})" class="px-3 py-1 border-2 rounded-lg bg-slate-300 border-slate-400 hover:bg-red-500 hover:text-white hover:border-red-700">
